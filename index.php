  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-body">
		...
		<div class="row">
		<div class="col-md-4">
		 <img src="image/OIP.jpg" width=100 height=100 alt="Mortada Nizar Karim" class="img-rounded">
		 </div>
		 <div class="col-md-5">
		<a style="color:#202020; font-family:'typo' ; font-size:18px; text-decoration:none" title="Find on insragram">Mortada Nizar Karim</a>
		<h4 style="color:#202020; font-family:'typo' ;font-size:16px" class="title1">+9647726542968</h4>
		<h4 style="font-family:'typo' ">mkm9284@gmail.com</h4>
		<h4 style="font-family:'typo' ">Al-Furat Al-Awsat Technical University, Technical Administrative College, Kufa, I.T Department</h4></div></div>
		</p>
      </div>
